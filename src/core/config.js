/*
  ...
  English is the source of truth; the `hi`/`gu` fields below are OPTIONAL
  manual overrides — leave them empty to let the shared glossary
  (src/core/glossary.js) derive the translation automatically.
*/
window.NDD_CONFIG = {
  "brand": {
